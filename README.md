...
靈感來自家裡長輩做陶瓷的創業夢，我把這個想法做成了一個電商網站！
可以逛商品、看商品詳細介紹、加購物車、走完線上結帳流程。
...
| 路由管理      | `react-router-dom`                                    | 頁面路由切換與動態路由處理              |
| 狀態管理      | `@reduxjs/toolkit`, `react-redux`                     | 管理購物車、Toast 狀態                  |
