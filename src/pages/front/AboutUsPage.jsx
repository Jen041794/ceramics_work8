const AboutUsPage = () => {
  return (
    <>
      ...
      <div
        className="container mb-2 mb-md-5 flex-column"
      ...
      >
        ...
        <div className="creative-concept d-flex align-items-center justify-content-between g-md-5 flex-column flex-md-column flex-lg-row">
          <p
            className="concept-content p-0 p-md-4 fs-4 text-start"
          ...
          <img
            style={{ width: "100%" }}
            className="rounded-3"
            src="https://images.unsplash.com/photo-1590605105526-5c08f63f89aa?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y2VyYW1pY3N8ZW58MHx8MHx8fDA%3D"
            alt=""
          />
        </div>
      </div>
      ...
      <div className="container mt-5 mt-md-0 mb-5" data-aos="fade-up">
        ...
        <ul className="awards">
          ...
          <li>
            <p className="fs-4">融合餐具組，2008陶瓷金質獎 創意餐具組 銀獎</p>
          </li>
          <li>
            <p className="fs-4">
          ...
          <li>
            <p className="fs-4">
              你儂我儂，2007陶瓷新品評鑑展入選 ，分離組合結構專利產品 專利號 M
              277379 號
            </p>
          </li>
          <li>
            <p className="fs-4">迴，2009 陶瓷青花艷品牌計畫 入選</p>
          </li>
          <li>
            <p className="fs-4">向前，2010第五屆台灣陶瓷金質獎 優選</p>
          </li>
        </ul>
      </div>
